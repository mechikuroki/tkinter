...
class Inventory:
    ...
    #esto carga el .jsonl de a pedazos y lo manda al json_to_tree, que hace los nodos de los productos y las leaves de sus detalles 
    def load_json_file(self, tree):
        try:
            ...
            messagebox.showerror("E;rror", f"Falló en cargar el archivo JSON\n{e}")
